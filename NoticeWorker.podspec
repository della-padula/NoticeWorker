...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/della-padula/SSU_OpenSource_Team"
  ...
  spec.source       = { :git => "https://github.com/della-padula/SSU_OpenSource_Team.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "iOS/NoticeWorker/**/*"
